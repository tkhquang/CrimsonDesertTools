...
namespace EquipHide
{
     ...
     * @details Temporarily overrides item priority bitmasks so PostfixEval treats head-covering items as inactive,
     *          preventing hair-hiding when Helm/Cloak/Mask is hidden. Only applies to the player context.
     */

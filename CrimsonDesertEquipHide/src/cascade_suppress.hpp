...
namespace EquipHide
{
     ...
     * @param body_comp The body component the engine updates.
     * @param slot_id The equipment slot the engine writes.
     * @param item_id The item the engine places in that slot.

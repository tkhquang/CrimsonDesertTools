...
#ifndef TRANSMOG_DYE_COLOR_TABLE_HPP
#define TRANSMOG_DYE_COLOR_TABLE_HPP
...
namespace Transmog::dye_color_table
{
    ...
    inline constexpr std::size_t GROUP_COUNT = 10;
    extern const Group GROUPS[GROUP_COUNT];
...
#endif // TRANSMOG_DYE_COLOR_TABLE_HPP

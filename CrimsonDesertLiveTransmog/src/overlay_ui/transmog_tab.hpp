...
// (Enabled / Instant Apply / Keep Search Text), character picker (per-character preset routing + body-kind override),
// and the preset management section (Append / Copy / Save as New / Remove / Prev /
// Next + rename).
//
// Each function ends with the trailing ImGui::Separator that visually closes its block, keeping the caller free of

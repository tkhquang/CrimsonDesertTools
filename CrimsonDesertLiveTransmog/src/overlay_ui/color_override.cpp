...
//
// Per-slot Color Override tab body.  Drawn inside the dye-popup tab
// bar's "Color Override" tab item; the caller owns the
...
Transmog::ColorOverride::Reinit::
    schedule_color_commit_retick(static_cast<int>(slot));
                    }

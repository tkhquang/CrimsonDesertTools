...
// Thin wrapper over CDCore::scan_indexed_string_table. Preserves the existing free-function signature so call sites
// (transmog.cpp, part_show_suppress.cpp, etc.) don't need to change.
